...
#'   \itemize{
#'     \item \code{\link{scale_color_callier}()}: create a ggplot color scale using Callier Center colors
#'   }
#'
#'
#' @section Other functions:
#'   \itemize{
#'     \item \code{\link{ColorChart}()}: print a color chart (a grid of color chips) for a palette
#'   }
#'
#' @docType package
#' @name callier
